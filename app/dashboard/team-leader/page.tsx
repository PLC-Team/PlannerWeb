        ...
        {visibleProjects.length === 0 ? (
          ...
          <div className="flex flex-col gap-3 z-10 relative">
            {visibleProjects.map((proj) => {
              ...
              const openReviews = pendingReviews[proj.id] || 0;
                ...
                >
                  ...
                  <div className="w-full md:w-64 flex flex-col gap-2 shrink-0 my-2 md:my-0 md:px-4 md:border-l md:border-white/5">
                    ...
                    <div className="flex gap-4 mt-1">
                      ...
                      <div className="flex items-center gap-1.5" title="Pending Reviews">
                        <CheckCircle className={`w-3.5 h-3.5 ${openReviews > 0 ? 'text-purple-400 animate-pulse' : 'text-slate-500'}`} />
                        <span className={`text-[10px] font-bold ${openReviews > 0 ? 'text-purple-400' : 'text-[#64748B]'}`}>
                          {openReviews}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center gap-2 shrink-0 md:pl-4 md:border-l md:border-white/5 border-t border-white/5 md:border-t-0 pt-3 md:pt-0">
                    <button
                      ...
                      className="text-[10px] font-extrabold uppercase tracking-widest px-4 py-2 rounded-xl border border-[#06B6D4]/30 text-[#06B6D4] bg-[#06B6D4]/5 hover:bg-[#06B6D4]/10 hover:border-[#06B6D4]/60 hover:shadow-[0_0_12px_rgba(6,182,212,0.25)] flex items-center gap-1.5 group transition-all duration-300 w-full md:w-auto justify-center"
                    >
